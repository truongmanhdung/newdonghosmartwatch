    ...
    <header id="trangchu">
      ...
      <div class="header-content container">
        <div class="row header-content_list">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 header-content-item" data-aos="fade-up"
    ...
    <main>
      <section class="product container">
        <div class="row product-list">
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" data-aos="fade-down-right" data-aos-easing="linear"
     data-aos-duration="1500" >
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" data-aos="fade-down-left" data-aos-easing="linear"
     data-aos-duration="1500">
        ...
        <div class="row product-list">
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 product5" data-aos="fade-down-left" data-aos-easing="linear"
     data-aos-duration="1500">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 product6" data-aos="fade-down-right" data-aos-easing="linear"
     data-aos-duration="1500" >
      ...
      <div class="swiper-container product11" data-aos="fade-down"
     ...
     data-aos-duration="1500">
      ...
      <section class="REVIEW" id="review" data-aos="flip-left"
     ...
     data-aos-duration="2000">
      ...
      <!-- end review -->
      <section class="section_video" data-aos="fade-up"
      ...
      <section id="tinhnang" class="tinhnang container">
        ...
        <div class="tinhnang_content">
          <div class="row tinhnang_content_list">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 tinhnang_item tinhnang_item_left product7"  data-aos="fade-down-right" data-aos-easing="linear"
     data-aos-duration="1500">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 tinhnang_icon_img product8" ata-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1500" >
              <img src="img/img dh/637381162983643737_gt2-pro-day-da-1.webp" alt="" />
            </div>

            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 tinhnang_item tinhnang_item_right product9" data-aos="fade-down-left" data-aos-easing="linear"
     data-aos-duration="1500">
              <div class="item_content">
      ...
      <section class="container" id="tintuc">
        ...
        <div class="product2"  data-aos="fade-up"
     data-aos-anchor-placement="center-bottom">
      ...
      <section class="section_video2" id="download" data-aos="fade-up"
     data-aos-anchor-placement="center-bottom">
      ...
      <section class="container blog" id="blog" data-aos="fade-left"
